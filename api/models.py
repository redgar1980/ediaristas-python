...
class Usuario(AbstractUser):
    ...
    objects = UserManager()
    diaristas_objects = diarista_manager.DiaristaManager()
...
class Diaria(models.Model):
    ...
    status = models.IntegerField(null=False, choices=STATUS_DIARIA_CHOICES,
        default=1)
    ...
    codigo_ibge = models.IntegerField(null=True, blank=False)
