...
class CidadesAtendimentoDiaristaID(APIView):
    ...
    def get(self, request, format=None):
        ...
        serializer_cidades_atendimento = cidades_atendimento_diarista_serializer.CidadesAtendimentoDiaristaSerializer(
            cidades_usuario, many=True)
        return Response(serializer_cidades_atendimento.data)

    def put(self, request, format=None):
        serializer_cidades_atendimento = relacionar_cidade_diarista_serializer.RelacionarCidadeDiaristaSerializer(
            data=request.data)
