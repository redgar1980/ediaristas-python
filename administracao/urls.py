...
urlpatterns = [
    path('diarias/listar', diaria_views.lista_diarias, name='lista_diarias'),
    path('diarias/<int:diaria_id>', diaria_views.transferir_pagamento_diaria, name='transferir_pagamento'),
    ...
    path("autenticacao/logout", usuario_views.signout, name="deslogar_usuario"),
